...
import MainPostInput from './main-post-input.component';
                ...
                <div className="container">
                    <div className="sidebar">
                        <div className="shortcut-links">            
                            ...
                            <a href="./home"><img src="images/home.png" /><p className="highlight">Home</p></a>
                        ...
                        <div className="right-info">
                            <div className="contacts">
                                ...
                                <ul>
                                    ...
                                    <li>Email: <span className="email">info@sunnydalevet.com</span></li>
                            ...
                            <div className="contacts">
                                ...
                                <ul>
                                    ...
                                    <li>Email: <span className="email">contact@riverbankanimalhospital.com</span></li>
                            ...
                            <div className="contacts">
                                ...
                                <ul>
                                    ...
                                    <li>Email: <span className="email">support@greenfieldpetclinic.com</span></li>
                            ...
                            <div className="contacts">
                                ...
                                <ul>
                                    ...
                                    <li>Email: <span className="email">appointments@harborviewvet.com</span></li>
                            ...
                            <div className="contacts">
                                ...
                                <ul>
                                    ...
                                    <li>Email: <span className="email">pinevet@pineridgeclinic.com</span></li>
                            ...
                            <div className="contacts">
                                ...
                                <ul>
                                    ...
                                    <li>Email: <span className="email">info@summitvethospital.com</span></li>
                            ...
                            <div className="contacts">
                                ...
                                <ul>
                                    ...
                                    <li>Email: <span className="email">contact@willowcreekanimalclinic.com</span></li>
                            ...
                            <div className="contacts">
                                ...
                                <ul>
                                    ...
                                    <li>Email: <span className="email">lakesidevet@lvpractice.com</span></li>
                            ...
                            <div className="contacts">
                                ...
                                <ul>
                                    ...
                                    <li>Email: <span className="email">mountainview@mvvetclinic.com</span></li>
                            ...
                            <div className="contacts">
                                ...
                                <ul>
                                    ...
                                    <li>Email: <span className="email">hello@citysideanimalhospital.com</span></li>
